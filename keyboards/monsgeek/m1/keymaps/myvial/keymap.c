...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FN] = LAYOUT_all( /* WASD/↑←↓→ */
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_SPD, RGB_SPI, _______,           KC_INS,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [FN] = { ENCODER_CCW_CW(RGB_VAI, RGB_VAD) }
};
#endif
